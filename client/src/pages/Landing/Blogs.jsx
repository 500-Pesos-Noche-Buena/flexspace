...
const Blogs = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-16 md:py-24">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="relative inline-block">
              ...
              {showLanguageMenu && (
                <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 bg-white rounded-xl shadow-xl border border-slate-100 overflow-hidden z-20 min-w-[160px]">
                  {languages.map((lang) => (
                    <button
                      key={lang.code}
                      onClick={() => {
      ...
      {featuredBlog && !searchTerm && selectedCategory === 'all' && (
        <div className="max-w-7xl mx-auto px-4 py-12">
          <Link 
            ...
            className="group block relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-xl hover:shadow-2xl transition-all duration-500"
          >
      ...
      {/* Newsletter Section */}
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 text-white py-16 mt-8">
