...
const SpaceDetails = () => {
    ...
    const availableSeats = (space?.capacity || 0) - (space?.occupied_seats || 0);
    const occupancyPercentage = space?.capacity > 0 
        ? Math.round((space.occupied_seats / space.capacity) * 100) 
        : 0;
                                    ...
                                    {weeklySchedule.map((item, idx) => (
                                        <div 
                                            ...
                                            className={`flex justify-between items-center p-3 ${
                                                idx !== weeklySchedule.length - 1 ? 'border-b border-slate-100' : ''
                            ...
                            <div className="p-6">
                                ...
                                <div className="mt-6 pt-6 border-t border-slate-100 space-y-2">
                                    <div className="flex items-center gap-2 text-xs text-slate-500">
                                        <Users size={14} /> Capacity: {space.capacity || 50} people
                                    </div>
                                    <div className="flex items-center gap-2 text-xs text-slate-500">
                ...
                {space && (
                    <div className="space-y-5 py-2">
                        ...
                        <div className="bg-linear-to-r from-indigo-50 to-purple-50 p-4 rounded-2xl">
                            <h3 className="font-[1000] uppercase text-sm text-slate-900">{space.name}</h3>
                            <p className="text-[10px] text-slate-500 mt-1">₱{space.rate_hour}/hour</p>
                        </div>
