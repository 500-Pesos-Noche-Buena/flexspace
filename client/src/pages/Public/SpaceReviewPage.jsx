...
const SpaceReviewPage = () => {
    ...
    const fetchSpaceDetails = async () => {
        try {
            ...
            showToast({ icon: 'error', title: 'Failed to load space' });
            setTimeout(() => navigate('/'), 2000);
        } finally {
            setLoading(false);
        }
    ...
    const handleSubmit = async () => {
        ...
        if (!customerName.trim()) {
            showToast({ icon: 'error', title: 'Please enter your name' });
            return;
        }
    ...
    if (!space) {
        return (
            <div className="min-h-screen bg-black flex items-center justify-center px-4">
                <Card className="bg-[#111114] border-white/5 max-w-md w-full text-center p-8">
                    <h2 className="text-xl font-black text-white mb-2">Space Not Found</h2>
                    <p className="text-slate-400 text-sm mb-6">The space you're looking for doesn't exist.</p>
                ...
                <Card className="bg-[#111114] border-white/5">
                    <CardContent className="p-6">
                        ...
                        <Button
                            ...
                            disabled={submitting || rating === 0 || !customerName.trim() || comment.trim().length < 10}
