...
<div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
    ...
    <div className="bg-indigo-500/5 border border-indigo-500/10 p-5 rounded-4xl flex items-center gap-4">
        ...
        <div>
            <p className="text-[9px] font-black uppercase tracking-widest text-slate-500">Total Listings</p>
    ...
    <div className="bg-emerald-500/5 border border-emerald-500/10 p-5 rounded-4xl flex items-center gap-4">
        ...
        <div>
            <p className="text-[9px] font-black uppercase tracking-widest text-slate-500">Active Spaces</p>
            <p className="text-xl font-[1000] text-white italic tracking-tighter">{stats.active}</p>
        </div>
    </div>
    ...
    <div className="bg-amber-500/5 border border-amber-500/10 p-5 rounded-4xl flex items-center gap-4">
        ...
        <div>
            <p className="text-[9px] font-black uppercase tracking-widest text-slate-500">Total Capacity</p>
            <p className="text-xl font-[1000] text-white italic tracking-tighter">{stats.capacity}</p>
        </div>
    </div>
</div>
